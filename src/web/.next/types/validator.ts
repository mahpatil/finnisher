...
// Validate ../../app/api/sessions/seed/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/sessions/seed">> = Specific
  const handler = {} as typeof import("../../app/api/sessions/seed/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
